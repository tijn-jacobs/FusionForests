...
%% Theorem environments (numbered within chapter for report class)
\theoremstyle{plain}
...
\title{Posterior Inference for Treatment Effects}
\author{Tijn Jacobs}
\date{\today}
...
\citep{neuenschwander2010,hupf2021bayesian}. Its evaluation requires one RCT-only refit
