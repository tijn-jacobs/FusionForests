...
\end{tikzpicture}
\caption{Illustration of the dimension-matching argument used in the \texttt{GROW} move. The left domain represents the initial tree configuration with a step height $h_3$ duplicated across two child regions. The right domain shows a proposed configuration where these regions are assigned distinct step heights $h_3'$ and $h_4'$.}
\label{fig:dim_match}
\end{figure}
