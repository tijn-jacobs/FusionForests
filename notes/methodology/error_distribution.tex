...
In our framework for combining randomized and real-world data under unmeasured confounding, the conditional expectation of the observed log-survival outcome admits the decomposition
\begin{equation}
