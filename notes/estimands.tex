...
\begin{itemize}[leftmargin=*]
  ...
  \item Time-varying acceleration factor models
        \citep{Crowther2023, Pang2021} are available if the AFT shift
...
\citet{Pang2021}. The latter generalisation comes at the cost of giving
...
\bibitem[Aalen et al.(2015)]{Aalen2015}
Aalen, O.~O., Cook, R.~J., and R{\o}ysland, K. (2015).
\newblock Does Cox analysis of a randomized survival study yield a
causal treatment effect?
\newblock \emph{Lifetime Data Analysis}, 21:579--593.

\bibitem[Brathovde et al.(2024)]{Brathovde2024}
Brathovde, M., Putter, H., Valberg, M., and Post, R.~A.~J. (2024).
\newblock The causal interpretation of acceleration factors.
\newblock \emph{arXiv preprint} arXiv:2409.01983.
...
\bibitem[Crowther et al.(2023)]{Crowther2023}
Crowther, M.~J., Royston, P., and Clements, M. (2023).
\newblock A flexible parametric accelerated failure time model and the
extension to time-dependent acceleration factors.
\newblock \emph{Biostatistics}, 24(3):811--831.

\bibitem[Hern\'an(2010)]{Hernan2010}
Hern\'an, M.~A. (2010).
\newblock The hazards of hazard ratios.
\newblock \emph{Epidemiology}, 21(1):13--15.

\bibitem[Hern\'an et al.(2005)]{HernanColeStrAFT2005}
Hern\'an, M.~A., Cole, S.~R., Margolick, J., Cohen, M., and Robins, J.~M.
(2005).
\newblock Structural accelerated failure time models for survival analysis
in studies with time-varying treatments.
\newblock \emph{Pharmacoepidemiology and Drug Safety}, 14(7):477--491.
...
\bibitem[Keiding et al.(1997)]{Keiding1997}
Keiding, N., Andersen, P.~K., and Klein, J.~P. (1997).
\newblock The role of frailty models and accelerated failure time models
in describing heterogeneity due to omitted covariates.
\newblock \emph{Statistics in Medicine}, 16(2):215--224.

\bibitem[Martinussen et al.(2020)]{MartinussenVansteelandtAndersen2020}
Martinussen, T., Vansteelandt, S., and Andersen, P.~K. (2020).
\newblock Subtleties in the interpretation of hazard contrasts.
\newblock \emph{Lifetime Data Analysis}, 26:833--855.

\bibitem[Pang et al.(2021)]{Pang2021}
Pang, M., Platt, R.~W., Schuster, T., and Abrahamowicz, M. (2021).
\newblock Flexible extension of the accelerated failure time model to
account for nonlinear and time-dependent effects of covariates on the
hazard.
\newblock \emph{Statistical Methods in Medical Research}, 30(11):2526--2542.

\bibitem[Post et al.(2024)]{Post2024b}
Post, R.~A.~J., van~den Heuvel, E.~R., and Putter, H. (2024).
\newblock The built-in selection bias of hazard ratios formalized using
structural causal models.
\newblock \emph{Lifetime Data Analysis}, 30:1--35.
