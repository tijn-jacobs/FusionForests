...
\end{align}
Each working response is treated as Gaussian with mean equal to the relevant forest and variance $\sigma^2$. Control observations carry no information about $\tau$; RCT observations and untreated OS observations carry no information about $c$. After the BART updates, recompute $R_i$ from~\eqref{eq:app-Ri}.
