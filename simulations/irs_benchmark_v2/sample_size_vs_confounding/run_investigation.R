...
#
# Design:
#   - Only block_rwd missingness (X5 missing in RWD)
#   - Only scenarios where X5 matters (1, 2, 3)
#   - Cross two factors:
#     (A) Sample size:  150/350, 350/150, 500/500
#     (B) Confounding:  alpha5 = 0.5 (confounded) vs 0 (no)
#   - Compare IRS vs Oracle vs Complete covariates
#
# If sample size drives the collapse:
#   Inverted (350/150) should recover IRS performance
# If confounding drives the collapse:
#   alpha5 = 0 should recover IRS even at 150/350
# ============================================================================
...
output_dir <- "sample_size_vs_confounding"
...
out_file <- file.path(output_dir, "investigation_results.rds")
