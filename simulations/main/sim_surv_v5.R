...
output_file <- file.path(Sys.getenv("TMPDIR"), "sim_surv_v5_output.rds")
...
# Place this script and sim_surv_v5_output.rds in the same folder and run from the repo
...
# ──────────────────────────────────────────────────────────────────────────────
res <- readRDS("simulations/main/sim_surv_v5_output.rds")
