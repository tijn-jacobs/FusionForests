...
output_file <- file.path(Sys.getenv("TMPDIR"), "sim_surv_v2_output.rds")
...
# Place this script and sim_surv_v2_output.rds in the same folder and run
...
# ──────────────────────────────────────────────────────────────────────────────
res <- readRDS("simulations/main/sim_surv_v2_output.rds")
