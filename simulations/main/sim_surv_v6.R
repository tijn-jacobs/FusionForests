...
cat("SIMULATION: FusionForest vs RCT-only vs RWD-only (SURVIVAL v6) -- HPC\n")
...
output_file <- file.path(Sys.getenv("TMPDIR"), "sim_surv_v6_output.rds")
...
# Place this script and sim_surv_v6_output.rds in the same folder and run from the repo
...
# ──────────────────────────────────────────────────────────────────────────────
# res <- readRDS("simulations/main/sim_surv_v6_output.rds")
#
