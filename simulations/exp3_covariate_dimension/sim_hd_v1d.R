...
p_grid   <- unique(round(10 ^ seq(log10(5), log10(500), length.out = 20)))[20]
...
output_file <- file.path(Sys.getenv("TMPDIR"), "sim_hd_v1d_output.rds")
...
# Place this script and sim_hd_v1d_output.rds at the paths below and run from the
...
# ──────────────────────────────────────────────────────────────────────────────
# res <- readRDS("simulations/exp3_covariate_dimension/sim_hd_v1d_output.rds")
# 
